...
#python siv.py -i -D /home/saddam/Desktop/SD -V ver.txt -R report1.txt -H MD5
#python siv.py -v -D /home/saddam/Desktop/SD -V ver.txt -R report2.txt
        ...
        if algo=='MD5' or algo=='SHA1': #hashing algo
            ...
            if os.path.isfile(verify)==1 and os.path.isfile(report)==1:
                ...
                if (os.path.commonprefix([monitor, verify]) == monitor) or (os.path.commonprefix([monitor, report]) == monitor):
                    print("Both Ver and Rep files are in outside\n")
                    sys.exit()
                else:
