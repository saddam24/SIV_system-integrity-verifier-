...
#if os.path.exists('report1.txt'):
#    print "File exists"

#else:
#   open("report1.txt", 'w')

#if os.path.exists('report2.txt'):
#    print "File exists"
...
# python siv.py -i -D TOOLS -V vDB -R report1.txt -H MD5
#python siv.py -v -D TOOLS -V vDB -R report2.txt 
    ...
    if os.path.isdir(monitor) == 1 or os.path.exists(monitor) == 1:
        ...
        if algo=='MD5' or algo=='SHA1': #hashing algo
            ...
            if os.path.isfile(verify)==1 and os.path.isfile(report)==1:
                ...
                os.open(verify, os.O_CREAT)
                os.open(report, os.O_CREAT)  
